...
# ###########################################################################
#
# Run a real.exe for 24 hours for input files [OPERATIONAL?????]
# 
# ###########################################################################
if { $real24 == "yes" } {
	puts $log "# ---------------------------------------------------------"
...
# ###########################################################################
#
# Generate Emissions: QFED Biomass Burning [OPERATIONAL??????]
# 
# ###########################################################################
if {$qfed == "yes"} {
...
# ###########################################################################
#
# Generate Emissions: Anthropogenic [INCOMPLETE]
# 
# ###########################################################################
if { $nei =="yes" } {
	puts $log "# ---------------------------------------------------------"
...
# ###########################################################################
#
# Generate Emissions: Tracers [OPERATIONAL???????????]
# 
# ###########################################################################
if { $tracer_gen == "yes" } {
	puts $log "# ---------------------------------------------------------"
...
# ###########################################################################
#
# Run WRF with Tracers [OPERATIONAL????????????????]
# 
# ###########################################################################
if { $wrftr == "yes"} {
...
# ###########################################################################
#
# Run WRF without fire [OPERATIONAL????????????]
# 
# ###########################################################################
if { $wrfnf == "yes" } {
...
# ###########################################################################
#
# Run MAIAC Inversion [INCOMPLETE]
# 
# ###########################################################################
if {$maiac == "yes"} {
	puts $log "# ---------------------------------------------------------"
